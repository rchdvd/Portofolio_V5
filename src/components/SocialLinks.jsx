...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/rcjh/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@richard_d4vdd",
    icon: Instagram,
    url: "https://www.instagram.com/richard_d4vdd/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@richardo david",
    icon: Youtube,
    url: "https://www.youtube.com/@Richardo_David",
    color: "#FF0000",
